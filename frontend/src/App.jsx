...
import TherapistEditProfile from './pages/therapist/TherapistEditProfile'
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/therapist/profile" element={<ProtectedRoute roles={['therapist']}><TherapistEditProfile /></ProtectedRoute>} />
